...
// import "../components/css/graphshs.css";
...
//     navigate("/FinalResultSHS"); // Redirect to FinalResultSHS page
//   };
...
//           <button onClick={redirectToFinalResultSHS} className="btn">View Final Result</button>
//         </div>
...
const OverallResult = () => {
  ...
  return (
    <>
      ...
      <div className="graph-container">
        <h1>Overall College Course Predictions</h1>
        <div className="top-choices">
          {topChoices.slice(0, 3).map(([strand], index) => (
            <p key={strand}>
              <strong>
